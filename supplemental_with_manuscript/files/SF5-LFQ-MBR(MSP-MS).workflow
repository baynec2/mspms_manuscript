# Workflow: LFQ-MBR(MSP-MS)


# Please edit the following path to point to the correct location.
# In Windows, please replace single '\' with '\\'
database.db-path=/home/nanopore-catalyst/centralized_files/proteome_databases/2024-11-14-decoys-mspms_peptide_library.fasta.fas
...
msfragger.digest_max_length=14
msfragger.digest_min_length=5
...
msfragger.misc.fragger.enzyme-dropdown-1=null
...
msfragger.search_enzyme_name_1=null
...
phi-report.filter=--sequential --prot 0.1
